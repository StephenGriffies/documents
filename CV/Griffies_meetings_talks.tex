...
\item Jun 2026: {\sc Fundamentals of ocean models and the analysis of ocean simulations}. Five lectures (two hours each) concerning the ocean equations forming the foundations of NEMO. Paris, France.  

\item May 2026: {\sc A primer on the ocean mesoscale and its parameterization in
  circulation models: Sampling the physics/maths/numerics (with a focus on tracers)}, talk given at the Institut Henri {Poincar\'{e}} workshop: \\ {\it Instabilities and Transitions in Geophysical Flows}.
